import type { IChapterRecord, IReviewRecord, IRevisionDictRecord, ISpacedRepetitionRecord, IWordRecord, LetterMistakes } from './record'
...
class RecordDB extends Dexie {
  ...
  spacedRepetitionRecords!: Table<ISpacedRepetitionRecord, string>
  ...
  constructor() {
    ...
    this.version(4).stores({
      ...
      chapterRecords: '++id,timeStamp,dict,chapter,time,[dict+chapter]',
      reviewRecords: '++id,dict,createTime,isFinished',
      spacedRepetitionRecords: '&word,nextReviewAt',
    })
  }
}
